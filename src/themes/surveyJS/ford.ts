...
import { IExtendedTheme } from "meridian-base/src/interfaces";

export const themeJSON: IExtendedTheme = {
    themeName: "__ford",
    colorPalette: "light",
    isPanelless: false,
    backgroundImage: "",
    ...
    header: {
        ...
        backgroundImage:
            "https://cdn.latitudewebservices.com/expanse_marketing/2024/ford/FordTerrain_treads_background.png",
    ...
    cssVariables: {
        "--sjs-font-family": "FordF1, arial, sans-serif",
        ...
        "--sjs-font-headertitle-size": "40px",
...
export const initThemeFord = (creator: SurveyCreatorModel) => {
    const themeTabPlugin = creator.themeEditor;
    themeTabPlugin.addTheme(themeJSON);

    const enLocale = editorLocalization.getLocale("en");
    enLocale.theme.names['__ford'] = "Ford F1 Theme";
};

export const fordCSS = {
    root: "sd-root-modern",
    title: "sd-title headline-1-large-semibold",
    ...
    navigationButton: "",
    bodyNavigationButton: "fds-button-primary body-2-bold",
    ...
    question: {
        ...
        headerTop: "fds-title-spacing sd-element__header--location-top",
        headerBottom: "sd-question__header--location--bottom",
        content: "sd-element__content",
        ...
        titleOnError: "",
        title: "fds-question-label body-2-regular",
        titleExpandable: "",
        titleExpandableSvg: "",
        titleExpanded: "",
        titleCollapsed: "",
        ...
        number: "sd-element__num fds-question-label body-2-regular",
        description: "fds-question-description caption-regular",
        descriptionUnderInput: "fds-question-description caption-regular",
    ...
    error: {
        ...
        icon: "fds-error-icon",
        item: "fds-error-item",
        locationTop: "fds-error-location-top",
        locationBottom: "fds-error-location-bottom"
    },
    checkbox: {
        root: "sd-selectbase",
    ...
    radiogroup: {
        radiobuttongroupcontainer: "fds-radio-button-group-container",
        root: "sd-selectbase",
        rootMobile: "sd-selectbase--mobile",
        rootRow: "sd-selectbase--row",
        rootMultiColumn: "sd-selectbase--multi-column",
    ...
    text: {
        root: "fds-input body-1-regular",
        small: "body-1-regular",
        controlDisabled: "fds-input--disabled",
        controlReadOnly: "fds-input--readonly",
        controlPreview: "",
        constrolWithCharacterCounter: "sd-text__character-counter",
        characterCounterBig: "sd-text__character-counter--big",
        content: "sd-text__content",
        remainingCharacterCounter: "sd-remaining-character-counter",
        onError: "fds-input--error"
    },
    emailtextinput: {
        root: "fds-input body-1-regular",
        small: "body-1-regular",
    ...
    multipletext: {
        ...
        content: "sd-multipletext__contentsd-question__content",
    ...
    matrixdynamic: {
        ...
        tableWrapper: "sd-table-wrapper",
        rootAlternateRows: "sd-table--alternate-rows",
        content: "sd-matrixdynamic__contentsd-question__content",
        cell: "sd-table__cell",
        cellResponsiveTitle: "sd-table__responsive-title",
        row: "sd-table__row",
        rowDelayedEnter: "sd-table__row--delayed-enter",
    ...
    comment: {
        ...
        controlReadOnly: "sd-input--readonly",
        controlPreview: "sd-input--preview",
        content: "sd-comment__contentsd-question__content",
        remainingCharacterCounter: "sd-remaining-character-counter",
        onError: "sd-input--error"
    },
    ...
    radiobuttongroup: {
        container: "fds-radio-button-group-container",
        root: "fds-radio-button-group-item",
        rootSmall: "fds-radio-button-group-item-small",
        rootLarge: "fds-radio-button-group-item-large",
        rootActive: "fds-radio-button-group-item-active",
        rootDisabled: "fds-radio-button-group-item-disabled"
    },
    checkboxvoi: {
        container: "fds-checkbox-voi-container",
        root: "fds-checkbox-voi-item",
        rootActive: "fds-checkbox-voi-item-active",
        rootDisabled: "fds-checkbox-voi-item-disabled",
        image: "fds-checkbox-voi-item-image"
    },
};